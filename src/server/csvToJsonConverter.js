...
convertCsvToJson('matches', matchesOutputFilePath, (errorMatches, dataMatches) => {
    if (errorMatches) {
       console.error(errorMatches)
    }
})

convertCsvToJson('deliveries', deliveriesOutputFilePath, (errorDeliveries, dataDeliveries) => {
    if(errorDeliveries){
